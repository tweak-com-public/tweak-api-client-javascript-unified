(function () {
    ...
    function TweakPortal($log) {
         ...
         * @param status                 {string}                  enum: private, public
         ...
         * @param featureHtmlBuilder     {boolean}                 
         * @param created                {string}                  format: date-time  
         * @param modified               {string}                  format: date-time  
         * @param id                     {string}                  
         * @param teamId                 {string}                  
         * @param defaultBuilderConfigId {string}                  
         * @param defaultBuilderConfig   {object}                  $ref: #/definitions/TeamBuilderConfig  
         ...
         * Private properties
         */
        var parameters = ['name', 'logo', 'status', 'language', 'featureHtmlBuilder', 'created', 'modified', 'id', 'teamId', 'defaultBuilderConfigId', 'defaultBuilderConfig', 'templates', 'templateRels', 'members', 'portalMembers', 'team', 'designs', 'templateFolders', 'designFolders', 'imageFolders', 'permission', 'dynamicDatas', 'fonts'];
        var parametersType = ['string', 'object', 'string', 'string', 'boolean', 'string', 'string', 'string', 'string', 'string', 'object', 'array', 'array', 'array', 'array', 'object', 'array', 'array', 'array', 'array', 'object', 'array', 'array'];
