(function () {
    ...
    function TweakAssetEvent($log) {
         ...
         * @param model             {string}    [REQUIRED]    enum: Asset, AssetCollection
         ...
         * Private properties
         */
        var parameters = ['description', 'context', 'action', 'model', 'modelId', 'created', 'modified', 'id', 'assetId', 'assetCollectionId', 'teamId', 'teamMemberId', 'asset', 'assetCollection', 'teamMember', 'team'];
        var parametersType = ['string', 'object', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'object', 'object', 'object', 'object'];
