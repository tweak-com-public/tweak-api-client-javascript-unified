(function () {
    ...
    function TweakAssetCollectionMember($log) {
         ...
         * Private properties
         */
        var parameters = ['message', 'requireToLogin', 'downloadLowResolution', 'hasDownloadPermission', 'hasEditPermission', 'hasViewPermission', 'created', 'modified', 'id', 'collectionId', 'memberId', 'assetCollection', 'member'];
