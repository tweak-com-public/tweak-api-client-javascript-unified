(function () {
    ...
    function TweakAssetUpload($log) {
         ...
         * Private properties
         */
        var parameters = ['status', 'rejectionMessage', 'created', 'modified', 'id', 'teamId', 'assets', 'team'];
        var parametersType = ['string', 'string', 'string', 'string', 'string', 'string', 'array', 'object'];
